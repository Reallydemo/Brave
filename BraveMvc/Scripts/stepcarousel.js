...
var stepcarousel={
	...
	addnavbuttons:function(config, currentpanel){
		config.$leftnavbutton=$('<img class="scrollbut" src="'+config.defaultbuttons.leftnav[0]+'">').css({zIndex:50,   cursor:'hand', cursor:'pointer'}).attr({title:'Back '+config.defaultbuttons.moveby+' panels'}).appendTo('body')
		config.$rightnavbutton=$('<img class="scrollbut" src="'+config.defaultbuttons.rightnav[0]+'">').css({zIndex:50,  cursor:'hand', cursor:'pointer'}).attr({title:'Forward '+config.defaultbuttons.moveby+' panels'}).appendTo('body')
